...
# From https://github.com/Zigazou/PyMinitel/blob/master/minitel/Sequence.py

# Special character conversion tables
UNICODEVERSVIDEOTEX = {
    '£': '1923', '°': '1930', '±': '1931', 
    '←': '192C', '↑': '192D', '→': '192E', '↓': '192F', 
    '¼': '193C', '½': '193D', '¾': '193E', 
...
class Sequence:
    ...
    def canonise(self, valeur):
        ...
        If a list is submitted, regardless of its depth, it will be
        ...
        :returns:
            A list of depth 1 of integers representing values in
            ASCII standard.
        ...
        # Recursively transform each element of the list into an integer
        canonise = []
        for element in valeur:
            if isinstance(element, str):
                # This loop handles 2 cases: where list is a unicode string
                # and where element is a string
    ...
    def __str__(self):
        """Returns a string representation of the sequence in hexadecimal format
