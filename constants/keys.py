...
if MODE == "minitel":
    ...
    LINE_VERTICAL_LEFT = 0x7B
    LINE_VERTICAL_CENTER = 0x7C
    LINE_VERTICAL_RIGHT = 0x7D

    LINE_HORIZONTAL_TOP = 0x7E
    LINE_HORIZONTAL_CENTER = 0x60
    LINE_HORIZONTAL_BOTTOM = 0x5F
